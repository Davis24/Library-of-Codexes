                    ...
                    <?php 
                        ...
                        if($result = $db -> query($query)){
                            while($row = $result -> fetch_assoc()) {
                                ...
                                echo '<label class="checkbox-label"><input type="checkbox" class="w3-check" value="'.$val.'" ><span class="tooltip" data-balloon-length="large"  data-balloon="'.$row["EBOOK_DESCRIPTION"].'" data-balloon-pos="right" >'.$row["TITLE"].'</span></label>';
                            }
                        }                         
                    ?>                   
                    </div>

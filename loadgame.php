<?php
	if(isset($_POST['game'])) {
		...
		echo '<h1><b><a href="/game='.$game_id.'/'.$game_temp.'">'.$game_title.'<i class="fa fa-angle-double-right" aria-hidden="true"></i></a></b></h1><h3><a href="files/azw3/'.$game_temp.'.azw3">AZW3</a> · <a href="files/epub/'.$game_temp.'.epub">EPUB</a> · <a href="files/pdf/'.$game_temp.'.pdf">PDF</a></h3><p>'.$row["GAME_DESCRIPTION"].'</p>';
}  ?>
<?php 
	require_once 'C:/xampp/htdocs/LibraryofCodexes/inc/header.php';
	$codex_id = $_GET['codex'];
	$previous = 0;
	$next = 0;
...
<p><a href="<?php echo URLROOT; ?>/data/editdata.php?codex=<?php echo $previous?>">Previous</a> ||| <a href="<?php echo URLROOT; ?>/data/editdata.php?codex=<?php echo $next?>">Next </a>
<?php
	...
	GROUP BY
		...
		c.CODEX_TITLE
		#22655
	HAVING c.FK_GAME_ID = 63  and c.CODEX_ID = $codex_id ORDER BY c.CODEX_TITLE ASC

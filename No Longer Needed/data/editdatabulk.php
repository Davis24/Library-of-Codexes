...
<?php
	...
	GROUP BY
		c.CODEX_ID,
		c.CODEX_TITLE
	HAVING c.FK_GAME_ID = 63 and CODEX_ID >= 25723 and CODEX_ID <= 26106 ORDER BY c.CODEX_TITLE ASC
...
<script src="<?php echo URLROOT; ?>/scripts/edit_bulk_data_scripts.js"></script>
</footer>